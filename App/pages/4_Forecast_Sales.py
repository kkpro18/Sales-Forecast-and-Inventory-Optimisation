...
if not SessionManager.is_there("data") or not SessionManager.is_there("column_mapping"):
    ...
    if SessionManager.is_there("selected_seasonality"):
        ...
        train_product_sales_raw[column_mapping['date_column']] = train_product_sales_raw[column_mapping['date_column']].astype(str)
        ...
        test_product_sales_raw[column_mapping['date_column']] = test_product_sales_raw[column_mapping['date_column']].astype(str)
        ...
        train_product_sales_raw_with_exog[column_mapping['date_column']] = train_product_sales_raw_with_exog[column_mapping['date_column']].astype(str)
        ...
        test_product_sales_with_exog_raw[column_mapping['date_column']] = test_product_sales_with_exog_raw[column_mapping['date_column']].astype(str)
